...
const Header = () => {
  return (
    <header className='w-full bg-transparent text-gray-800 fixed top-0 h-36 z-10'>
      <div className='w-full absolute top-16 left-12'>
        <div className='flex justify-start w-64 items-center gap-6 mt-2'>
          <div className='w-24 text-center flex justify-center items-center border border-blue-600 border-opacity-25 border-2 rounded-md h-8 '>
